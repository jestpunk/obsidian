...
В *свёрточной сети* сначала идут свёрточные слои, нелинейность, пуллинг, а потом обычная, привычная полносвязка. Свёрточные сети подходят для обработки любых "равномерных сигналов" – и звуки, и видеоряды
