...
Для того, чтобы понять настроение текста используется обратная архитектура *many to one*, которая по списку (тексту) генерирует одно эмоциональное описание. 
