...
### Какое разбиение выбирать? Классификация
...
![[Pasted image 20230622110717.png]]
...
### Какие разбиения проверять на практике?
...
- Можно использовать для признаков разных видов (категориальные / вещественные), также отлично работает с пропусками
- 