...
Для этого вводится *impurity* — мера неоднородности множества. Пусть есть область $area$. Мы хотим побить её каким-то порогом на подобласти $area_L,\;area_R$. Тогда если $I(area)$ — мера частоты области, мы хотим максимизировать следующий функционал
