...
6. Обучение с частично размеченными данными
7. Привелегированное обучение

### Математика
1. Связь плотности и вероятности
2. Параметры случайной величины
3. Оценки
...
11. Сингулярное разложение
12. Матричное дифференцирование

### Метрические методы 
1. Метрики
1. Метод ближайших центроид
1. KNN
1. Сглаживание Надарая-Ватсона
1. Обучение метрики

### Приближенные метрические методы
1. kD-дерево
1. Random trees
1. LSH
1. Boundary trees
...
&nbsp;
### Обучение с частично размеченными данными (*semi-supervised*)
...
&nbsp;
### Привелегированное обучение (*LUPI*)
...
Перебрать параметры можно, во-первых простенькой сеткой. То есть ждя каждого параметра модели мы составляем множество перебираемых значений и проходимся по получающейся сетке значений
...
### Покоординатный спуск (0 порядок)
...
### Стохастический градиентный спуск / SGD (1 порядок)
...
### Поиск ортогонального соответствия
...
### Бинарная классификация и сигмоида
