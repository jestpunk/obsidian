...
TODO (dtype как аргумент init)

Знание типов данных поможет нам перевести числа из одного типа данных в другой. Для этого в Numpy используется метод `astype`, в котором в качестве аргумента указывается нужный тип данных
