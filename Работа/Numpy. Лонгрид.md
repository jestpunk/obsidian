...
В реальных задачах связанных со статистическим анализом, машинным обучением или эконометрикой, размерность массива может достигать десятков и сотен измерений, а общее число значений измеряться миллионами. В таких случаях ручная проверка уже не поможет, и поля `size`, `shape` и `ndim` становятся действительно незаменимыми

```Python
# Пример пятимерного массива. 
# Определить его форму "вручную" сложнее, чем gjcметод
# [[[[[0. 0. 0. 0.]
#     [0. 0. 0. 0.]] 
#
